...
<div class="p-5 bg-light card border border-dark rounded">
    ...
    <form class="card-body" action="${pageContext.request.contextPath}/registro" method="post" name="inicio"
        ...
        <div class="form-group col-sm-auto">
            <button class="btn btn-success" type="submit" name="peticion" value="reg" onclick="return registrar();">Registrarse</button>
            <button class="btn btn-warning" onclick="return borrar();">Borrar</button>
            <button class="btn btn-danger" type="submit" name="peticion" value="can" onclick="return cancelar();">Cancelar</button>
        </div>
